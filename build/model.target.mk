...
$(builddir)/model.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/model.node: LIBS := $(LIBS)
$(builddir)/model.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/model.node: TOOLSET := $(TOOLSET)
$(builddir)/model.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/model.node
# Add target alias
.PHONY: model
model: $(builddir)/model.node

# Short alias for building this executable.
.PHONY: model.node
model.node: $(builddir)/model.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/model.node
